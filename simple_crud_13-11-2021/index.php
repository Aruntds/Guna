...
while($r = mysqli_fetch_array($Show)): ?>
    <tr>
		...
		<td><a title="Click To Update" href="update.php?update_id=<?php echo $r['id']; ?>" class="btn btn-warning"><i class="fa fa-pencil-alt"></i></a></td>
		<td><a title="Click To Delete" href="delete.php?delete_id=<?php echo $r['id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></a></td>
    </tr>
    <?php endwhile; ?>
 </tbody>
 </table>
